# httpSandwich MVP Implementation
...
```bash
httpSandwich --from 8000 --to 5009           # Proxies localhost:8000 → localhost:5009
httpSandwich --from 8000 --to localhost:5009 # Same as above
httpSandwich --from 8000 --to 192.168.1.5:80 # Proxies to different host
```
